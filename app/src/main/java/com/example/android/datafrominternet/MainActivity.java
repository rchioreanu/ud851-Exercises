...
public class MainActivity extends AppCompatActivity {
    ...
    public void makeGithubSearchQuery() {
        EditText mQueryFieldEditText;
        TextView mSearchResultTextView;

        mQueryFieldEditText = (EditText) findViewById(R.id.et_search_box);
        mSearchResultTextView = (TextView) findViewById(R.id.tv_github_search_results_json);

        String githubQuery = mQueryFieldEditText.getText().toString();
        NetworkUtils networkUtils = new NetworkUtils();
        String queryStringURL = networkUtils.buildUrl(githubQuery).toString();

        mSearchResultTextView.setText(queryStringURL);
    }
